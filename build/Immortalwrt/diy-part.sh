...
git clone https://github.com/timsaya/luci-app-bandix feeds/luci/themes/luci-theme-argon feeds/packages/bandix
...
# 内核和系统分区大小(不是每个机型都可用)
export Kernel_partition_size="88"            # 内核分区大小,每个机型默认值不一样 (填写您想要的数值,默认一般16,数值以MB计算，填0为不作修改),如果你不懂就填0
